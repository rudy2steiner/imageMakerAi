...
export async function generateMetadata({ params }: any) {
    ...
    return {
        ...
        keywords: 'flux pro, image maker ai, ai image maker, text to an image,text to the image,best text to image online,text to images,convert text to image,flux image generator,image generator online,ai image generator from text,ai image generator,realistic ai image generator, anime image generator',
        icons: {
            icon: "/favicon.ico",
